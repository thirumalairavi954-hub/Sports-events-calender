...
<head>
  ...
  <title>Available Events - Anti-Gravity Engine</title>
  ...
  <style>
    *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .table tbody td:first-child { text-align: left; font-weight: 700; color: var(--neon-blue); }
    ...
    .btn-action { background: linear-gradient(135deg, rgba(0, 170, 136, 0.9), rgba(0, 204, 153, 0.9)); color: white; border: none; padding: 10px 18px; border-radius: 10px; font-family: var(--font-tech); font-weight: 700; font-size: 13px; text-transform: uppercase; cursor: pointer; transition: all 0.3s; text-decoration: none; display: inline-flex; align-items: center; gap: 6px; box-shadow: 0 4px 10px rgba(0, 170, 136, 0.2); }
    .btn-action:hover { transform: translateY(-2px); box-shadow: 0 8px 15px rgba(0, 170, 136, 0.4); color: white; }
    ...
    <div class="card">
      <div class="header-area">
        <div class="title-group">
          <h3><i class="fa fa-list-ul"></i> Events Directory</h3>
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="register_event.php?id=<?php echo $row['event_id']; ?>" class="btn-action">
                  <i class="fa fa-id-badge"></i> Authenticate / Register
                </a>
              </td>
            </tr>
            <?php } ?>
